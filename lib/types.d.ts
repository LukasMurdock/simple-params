...
export type NeverRight<L extends KeyVal, R extends KeyVal> = GetObjectKeyVals<L> & {
    [K in keyof R]?: never;
};
export type Either<L extends KeyVal, R extends KeyVal> = NeverRight<L, R> | NeverRight<R, L>;
